...
CREATE TABLE IF NOT EXISTS icinga_hosts (
  ...
  notes_expanded TEXT character set latin1  default '',
  notes_url TEXT character set latin1  default '',
  notes_url_expanded TEXT character set latin1  default '',
  action_url TEXT character set latin1  default '',
  action_url_expanded TEXT character set latin1  default '',
  icon_image TEXT character set latin1  default '',
  icon_image_expanded TEXT character set latin1  default '',
