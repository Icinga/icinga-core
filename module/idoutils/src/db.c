...
int ido2db_oci_prepared_statement_hoststatus(ido2db_idi *idi) {
	...
	if (asprintf(&buf,
	             ...
	             "retry_check_interval=:X45, check_timeperiod_object_id=:X46, executed_command=:X47 "
	             "WHEN NOT MATCHED THEN "
	             ...
	             "retry_check_interval, check_timeperiod_object_id, executed_command) "
...
int ido2db_oci_prepared_statement_servicestatus(ido2db_idi *idi) {
	...
	if (asprintf(&buf,
	             ...
	             "retry_check_interval=:X46, check_timeperiod_object_id=:X47, executed_command=:X48 "
	             "WHEN NOT MATCHED THEN "
	             "INSERT "
	             ...
	             "normal_check_interval, retry_check_interval, check_timeperiod_object_id, executed_command) "
	             "VALUES "
