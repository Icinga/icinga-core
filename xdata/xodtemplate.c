...
int xodtemplate_begin_object_definition(char *input, int options, int config_file, int start_line){
	...
	case XODTEMPLATE_SERVICEESCALATION:
		...
		new_serviceescalation->have_first_warning_notification=FALSE;
		new_serviceescalation->have_last_warning_notification=FALSE;
		new_serviceescalation->have_first_critical_notification=FALSE;
		new_serviceescalation->have_last_critical_notification=FALSE;
		new_serviceescalation->have_first_unknown_notification=FALSE;
		new_serviceescalation->have_last_unknown_notification=FALSE;
	...
	case XODTEMPLATE_HOSTESCALATION:
		...
		new_hostescalation->have_first_down_notification=FALSE;
		new_hostescalation->have_last_down_notification=FALSE;
		new_hostescalation->have_first_unreachable_notification=FALSE;
		new_hostescalation->have_last_unreachable_notification=FALSE;
