...
#define NEBFLAG_PROCESS_INITIATED             1         /* event was initiated by Icinga process */
...
void broker_log_data_with_host_service(int, int, int, char *, unsigned long, time_t, struct timeval *, host *, service *);
