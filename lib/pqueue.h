 ...
 */
/*
 * Altered for Icinga by Michael Friedrich <michael.friedrich@univie.ac.at>
 * using a patch from Nagios by Andreas Ericsson <ae@op5.se> with the
 * explicit consent of Volkan Yazici <volkan.yazici@gmail.com>. Thanks a lot.
 * Changed as follows:
 *
